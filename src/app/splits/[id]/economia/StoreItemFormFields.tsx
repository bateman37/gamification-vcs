...
export function StoreItemFormFields({
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
      ...
      <div>
        <label htmlFor={`${idPrefix}-priceCredits`} className="block text-sm font-medium text-slate-700">
          Precio (creditos)
        </label>
        <input
      ...
      <div>
        <label htmlFor={`${idPrefix}-equipmentSlotId`} className="block text-sm font-medium text-slate-700">
          Ranura
        </label>
        <select
      ...
      <div>
        <label htmlFor={`${idPrefix}-kpiCode`} className="block text-sm font-medium text-slate-700">
          KPI potenciado
        </label>
        <select
          id={`${idPrefix}-kpiCode`}
      ...
      <div>
        <label htmlFor={`${idPrefix}-bonusPercent`} className="block text-sm font-medium text-slate-700">
          Bonus
        </label>
        <select
